...
public class PanelCursos extends JPanel {
    ...
    private void confirmarYActualizarCurso() {
        ...
        try {
            ...
            Curso actualizado = new Curso(codigo, nombre, creditos, semestre);

            boolean ok1 = arregloCursos.actualizarCurso(codigo, actualizado);
            boolean ok2 = matrizSemestres.actualizarCurso(codigo, actualizado);
            boolean ok3 = listaCursos.actualizarCurso(codigo, actualizado);
            ...
            if (ok1 || ok2 || ok3) {
                ...
                JOptionPane.showMessageDialog(this, "No se encontró el curso para actualizar.");
            }
        } catch (NumberFormatException e) {
